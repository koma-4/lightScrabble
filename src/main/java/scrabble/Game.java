...
public class Game implements Runnable{
	...
	public void run() {
		...
		name1 = getUsername("Игрок 1");
		name2 = getUsername("Игрок 2");
	...
	public static JPanel inputImage() {
	    ...
	    public void initializePlayers() {
			...
			frame.add(initializeGameButtons(tempBoard,board, p1, p2, p3, p4, selectedLetter, squaresToSubmit, tileBenchPanel,
					letterBag, score1, score2, turn, score3, score4));

		}
		
		public JPanel initializeGameButtons (final GameBoard tempBoard, final GameBoard board,
										     final Player p1, final Player p2, Player p3, Player p4,
										     final Square selectedLetter, final List<Square> squaresToSubmit,
										     final JPanel tileBenchPanel, final LetterBag letterBag,
											 final JLabel score1, final JLabel score2, final JLabel turn,
											 final JLabel score3, final JLabel score4) {
			...
			pass.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					} else if (finalP != null && finalP.isMyTurn()) {
						if (finalP1 != null) {
