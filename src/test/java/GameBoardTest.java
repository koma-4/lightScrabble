...
public class GameBoardTest {
    ...
    private final LetterBag letterBag = new LetterBag("src/main/resources/letters.txt");

    @Test
    public void testFirstWordNotInCenter() {
        GameBoard g = new GameBoard("src/main/resources/smallDictionary.txt", letterBag);
